...
export default function PricingSection({ currentLang, onUpgradeSuccess, isPremium, theme = 'dark' }: PricingSectionProps) {
  ...
  const localDocs = {
    uz: {
      ...
      freeDesc: "Barcha transliteratsiya va mahalliy PDF asboblaridan to'liq ishonchli va bepul foydalaning.",
      freeBadge: "Bepul rejim",
    ...
    ru: {
      ...
      freeDesc: "Используйте все инструменты транслитерации и локальные PDF совершенно надежно и бесплатно.",
      freeBadge: "Бесплатный режим",
    ...
    en: {
      ...
      freeSub: "Basic Mode",
      freeDesc: "Use all transliteration and local PDF tools fully reliably and for free.",
      freeBadge: "Free Mode",
